...
namespace _4._ClassesPart1
{
    class Lecture
    {
        static void Main(string[] args)
        {
            ...
            // protected internal - The type or member can be accessed by any code in the assembly in which it's declared, or sub-classes (He's yet to see this in production)
            // private - this is the DEFAULT for class members (properties), only visible inside class (make these private to begin with). 
